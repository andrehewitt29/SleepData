                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-background">
                            <h5 style={{textAlign: "center", color: "#dddddd"}}><strong>General Questions:</strong></h5>
                            ...
                            <br />
                        <div class="form-background">
                            <h5 style={{textAlign: "center", color: "#dddddd"}}><strong>Via Strengths <a href="https://www.authentichappiness.sas.upenn.edu/questionnaires/survey-character-strengths" title="Click here to find out your VIA Strengths!" style={{color: "inherit", textDecoration: "inherit"}} rel="noreferrer" target="_blank">(?)</a>:</strong></h5>
                            ...
                            <br />
                        <div class="form-background">
                            <h5 style={{textAlign: "center", color: "#dddddd"}}><strong>Grit Score <a href="https://angeladuckworth.com/grit-scale/" title="Click here to find out your Grit Score!" style={{color: "inherit", textDecoration: "inherit"}} rel="noreferrer" target="_blank">(?)</a>:</strong></h5>
                            ...
                            <br />
                        <div class="form-background">
                            <h5 style={{textAlign: "center", color: "#dddddd"}}><strong>Love Language Score <a href="https://5lovelanguages.com/quizzes/love-language" title="Click here to find out your 5 Love Language Score!" style={{color: "inherit", textDecoration: "inherit"}} rel="noreferrer" target="_blank">(?)</a>:</strong></h5>
                            ...
                            <br />
                        <div class="form-background">
                            <h5 style={{textAlign: "center", color: "#dddddd"}}><strong>Exercise Questions:</strong></h5>
                            ...
                            <br />
                        <div class="form-background">
                            <h5 style={{textAlign: "center", color: "#dddddd"}}><strong>Consumption Questions:</strong></h5>
                            ...
                            <br />
                            <input type='submit' value="Done" style={{float: "center"}}></input>
                        </form>
                    </div>
                    <div class="col-md-3" />
                </div>
